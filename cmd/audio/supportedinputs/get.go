...
var GetSupportedInputsCmd = &cobra.Command{
	...
	Long: `Retrieves a list of all supported audio input schemas mapped
to their respective channel availability. This command helps you
discover exactly which input label strings are legally allowed to be
passed into 'bmctl audio input set'. The response will show hardware
ports (like "XLR 1", "3.5mm Left", "AES/EBU") alongside whether
they are active.`,
